...
SELECT DATEDIFF(CURDATE(), '199%-12-25'); #can use % in the String with numbers to get all data following 199 but not exceeding that format.
...
SELECT CONCAT('Days at company: ', DATEDIFF(CURDATE(), hire_date)) AS 'DAYS AT COMPANY'
FROM employees
